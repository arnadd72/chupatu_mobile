...
class _AdminHomePageState extends State<AdminHomePage> {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<AppThemeData>(
        ...
        builder: (context, theme, child) {
          ...
          // --- UPDATE DAFTAR HALAMAN (5 MENU) ---
          final List<Widget> pages = [
            _buildDashboardHome(theme),     // 0. HOME
            const AdminOrderListPage(),     // 1. ORDERS
            const AdminPOSPage(),           // 2. KASIR (POS)
            const AdminInventoryPage(),     // 3. GUDANG
            const AdminManagementPage(),    // 4. KELOLA
          ];
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _buildNavItem(Icons.point_of_sale_rounded, "Kasir", _selectedIndex == 2, theme, 2), // Kasir
                      _buildNavItem(Icons.inventory_2_rounded, "Gudang", _selectedIndex == 3, theme, 3),  // Gudang
  ...
  Widget _buildDashboardHome(AppThemeData theme) {
    return StreamBuilder<QuerySnapshot>(
      // Kita tetap ambil banyak data untuk statistik yang akurat
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Kartu Statistik
              Row(children: [
                _buildStatCard("Total Order", "$totalOrders", Icons.inbox, Colors.blue, theme),
                const SizedBox(width: 12),
                _buildStatCard("Perlu Proses", "$pendingOrders", Icons.priority_high_rounded, Colors.orange, theme)
              ]),
              const SizedBox(height: 12),
              Row(children: [
                _buildStatCard("Sedang Dicuci", "$processOrders", Icons.local_laundry_service_rounded, Colors.purple, theme),
                const SizedBox(width: 12),
                _buildStatCard("Pendapatan", currencyFormatter.format(revenue), Icons.monetization_on, Colors.green, theme)
              ]),
              ...
              // --- UPDATE: HANYA TAMPILKAN 3 DATA TERATAS ---
              ListView.builder(
                shrinkWrap: true, physics: const NeverScrollableScrollPhysics(),
                // Logic: Jika data > 3, ambil 3. Jika kurang, ambil semua.
        ...
        child: Column(
          children: [
            ...
            Row(children: [
              ...
              }, style: OutlinedButton.styleFrom(side: BorderSide(color: statusColor), backgroundColor: Colors.white.withOpacity(0.5), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))), child: Text("Detail", style: GoogleFonts.plusJakartaSans(color: statusColor, fontWeight: FontWeight.bold)))),
              const SizedBox(width: 8),
