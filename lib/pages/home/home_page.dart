        ...
        for (var change in snapshot.docChanges) {
          if (change.type == DocumentChangeType.modified) {
            ...
            FirebaseFirestore.instance
                .collection('users')
                .doc(user!.uid)
                .set({'hasUnreadNotif': true}, SetOptions(merge: true));
          }
        }
      });
    }
          ...
          builder: (context, userSnapshot) {
            ...
            return Scaffold(
              backgroundColor: theme
                  .background, // Background diubah jadi solid (menghapus efek gradasi)
              body: Stack(
                children: [
                  SafeArea(
                                      ...
                                      child: ListView(
                                          ...
                                          children: [
                                            ...
                                            AutoMagicCard(
                                                ...
                                                afterUrl:
                                                    'https://images.unsplash.com/photo-1515955656352-a1fa3ffcd111?q=80&w=600',
                  ...
                  if (_showFloatingPromo)
                    Positioned(
                        ...
                        child: Dismissible(
                            key: const Key('promo'),
                            onDismissed: (_) =>
                                setState(() => _showFloatingPromo = false),
                            child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        Text('Promo Gajian!',
                                            style: GoogleFonts.plusJakartaSans(
                                                ...
                                                fontSize: 14)),
                                        Text(
                                            'Diskon 30% semua layanan hari ini.',
                                            style: GoogleFonts.plusJakartaSans(
...
// --- HELPER METHODS ---
  Future<void> _navigateToService(
    ...
    try {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        debugPrint(
            "Layanan $serviceName belum disetting di Firebase. Pakai harga default.");
      }
  ...
  // HELPER METHOD BARU UNTUK GAMBAR PNG LOKAL
  Widget _buildImageServiceItem(
      String imagePath,
      String label,
      AppThemeData theme,
      Color itemColor,
        ...
        children: [
          Expanded(
            child: Container(
              ...
              // BUNGKUS GAMBAR DENGAN ClipRRect AGAR UJUNG GAMBAR IKUT MELENGKUNG
              child: ClipRRect(
                borderRadius: BorderRadius.circular(
                    19), // Disesuaikan agar tidak menutupi border
                child: Image.asset(
                  imagePath,
                  fit: BoxFit
                      .cover, // UBAH MENJADI COVER AGAR MEMENUHI KOTAK TANPA MERUSAK PROPORSI
                  errorBuilder: (context, error, stackTrace) => Center(
                    child: Icon(fallbackIcon, color: itemColor, size: 30),
                  ),
                ),
              ),
            ),
            ...
            child: Row(children: [
              ...
              Expanded(
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                    Text('Join Chupatu Pro',
                        style: GoogleFonts.plusJakartaSans(
                            color: const Color(0xFF0B0F19),
                            fontWeight: FontWeight.w800,
                            fontSize: 16)),
                    Text('Priority service & Gold status.',
                        style: GoogleFonts.plusJakartaSans(
              ...
              AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    double rotate =
                        math.sin(_upgradeAnimController.value * math.pi * 2) *
                            0.05;
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              "Status pesanan ${widget.serviceName} Anda telah diperbarui menjadi: ${widget.newStatus.toUpperCase()}",
                              style: GoogleFonts.plusJakartaSans(
                ...
                builder: (context, child) {
                  return Transform.rotate(
                    ...
                    child: Icon(Icons.notifications_none_rounded,
                        color: widget.theme.textMain.withOpacity(0.8)),
                  );
                }),
            if (widget.hasNewNotif)
              Positioned(
                ...
                child: const CircleAvatar(
                    radius: 3.5, backgroundColor: Colors.redAccent),
              ),
          ],
        ),
      ),
